      ...
      <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-3 md:col-span-2">
        ...
        <form class="grid gap-3 md:grid-cols-2">
          ...
          <div class="md:col-span-2 flex flex-wrap gap-3">
            <button type="submit" class="inline-flex items-center justify-center px-5 py-3 rounded-lg bg-brand-accent text-white font-semibold hover:bg-emerald-700 transition">{{ t('contacts.submit') }}</button>
